...
const Footer = () => (
  <div className="bg-brand-purple-800 md:px-4">
          ...
          <div>
            ...
            <ul className="font-roboto text-brand-purple-50 mb-4">
              <li className="flex gap-2 items-center">
                <FooterIcons.phone className="w-4" /> +385 123 0000
              </li>
              <li className="flex gap-2 items-center">
                <FooterIcons.envelope className="w-4" />
                design@fesb.hr
              </li>
            </ul>
            <div className="flex gap-2">
              <FooterIcons.facebook className="w-6" />
              <FooterIcons.twitter className="w-6" />
              <FooterIcons.linked className="w-6" />
              <FooterIcons.instagram className="w-6" />
            </div>
          </div>
        </div>
      </div>
